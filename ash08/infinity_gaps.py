...
GAPS = [
    ...
    {"id": "G-SELECT", "section": "Collision", "item": "SELECT floor", "report": "70 (AM07)", "live": "File 3: BUY 62–70 above 200 DMA; 70+ SELECT size ×0.50; below 200 DMA no SELECT; WATCH 55", "status": "SUPERSEDED"},
    {"id": "G-SIZE", "section": "Collision", "item": "Position size", "report": "AM07 vol-tier", "live": "½-Kelly IC 0.05 floor 61 cap 5%; 70+ size ×0.50", "status": "WIRED"},
    ...
    {"id": "G-DESK", "section": "Execution", "item": "AM07 operating desk (pages + clock + book)", "report": "AM07 /scan /positions /trades /risk /alerts /reports", "live": "ASH08 full desk: clock 09:20/14:30/15:25/15:35 + 45s robot, two-sided ticket, closed book, shadow, register, triggers, reports, settings. Numbers stay 5 Cr / File 3 62–70 / Kelly floor 61 / −3+6+15d.", "status": "WIRED_THIS_PASS"},
