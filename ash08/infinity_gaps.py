...
GAPS = [
    ...
    {"id": "G-DESK", "section": "Execution", "item": "AM07 operating desk (pages + clock + book)", "report": "AM07 /scan /positions /trades /risk /alerts /reports", "live": "ASH08 full desk: clock 09:20/14:30/15:25/15:35 + 45s robot, two-sided ticket, closed book, shadow, register, triggers, reports, settings. Numbers stay 5 Cr / Kelly / 68 / −3+6+15d.", "status": "WIRED_THIS_PASS"},
